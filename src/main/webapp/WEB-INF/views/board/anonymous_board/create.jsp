...
<div class="container"
	...
	<div class="panel">
		<div id="contAreaBox" class="panel-body">
			<form role="form" id="boardForm"
				action="/common/board/anonymous/create?${_csrf.parameterName}=${_csrf.token}"
    ...
    function redirectToPage() {
        ...
        switch (selectedValue) {
            case "2":
                window.location.href = "/common/board/anonymous/create";
                break;
            case "3":
            ...
            default:
					...
					<table id="datatable-scroller"
						...
						<tbody>
							<tr>
								...
								<input type="text" id="userNm" name="userNm" value="${userVO.userCd}" readonly style="width: 10%;" class="form-control" /> 
								<input type="text" id="userNm" name="userCd" value="${userVO.userCd}" readonly class="form-control" style="display: none;" /></td>
							</tr>
							<tr>
				...
				<div>
					...
					<a href="/common/board/anonymous/list" class="btn-two mini orange"
...
$(function() {
	...
	CKEDITOR.replace('bdCon', {
		filebrowserUploadUrl:'/common/board/anonymous/fileuploadCK?${_csrf.parameterName}=${_csrf.token}',
		height: 600
	});
