...
.free_box {
	...
	padding: 40px; overflow-y:scroll;
...
.free_box tbody tr:hover {
    background-color: #f2f3f4;
}

.free_box tbody tr:first-child:hover {
    background-color: #EEF1F6;
}
...
.page-item.active .page-link{
    ...
    color: #fff; background-color:#751c35;
/*     border-radius:50%; */
    cursor: pointer;  
}
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card" style="width: 102%;">
				<div class="topic">
					<div class="table_topic">자유게시판<i class="fa-solid fa-circle-info" style="color: #333333; position: absolute; top: 2px; left: 94px;"></i></div>

					<!------- 검색기능 ------->
					<form class="searchForm" action="/common/board/free/list"
