...
.publicize_box {
	width: 100%; overflow-y:scroll; height:calc(100% - 40px);
	padding: 40px;
...
.publicize_box tbody tr:hover {
    background-color: #f2f3f4;
}

.publicize_box tbody tr:first-child:hover {
    background-color: #EEF1F6;
}
/* /////////////////여기가 수정끝!!  */
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card" style="width: 102%;">
				<div class="topic">
					<div class="table_topic">홍보게시판<i class="fa-solid fa-circle-info" style="color: #333333; position: absolute; top: 2px; left: 94px;"></i></div>

					<!------- 검색기능 ------->
					<form class="searchForm" action="/common/board/publicize/list"
								...
								<table id="bootstrap-data-table"
									...
									<thead>
										<tr role="row" class="table_title">
											...
											<th width="64%;" class="text-center"><b>제목</b></th>
...
<!-- 페이지 시작 -->
								...
								<!-- 페이지 폼 시작 -->
								<form id='actionForm' action="/common/board/publicize/list"
									method="get">
...
<script>
	$(".btnDetail").on("click", function (event) {
		...
		$.ajax({
			...
			url: "/common/board/publicize/count?bdCd="+bdCd,
			type: "get",
			...
			success: (res) => {
				if (res != null) {
					location.href = "/common/board/publicize/detail?bdCd="+bdCd;
				}
			}
		});
