...
<!-- 카테고리 표시 : 이거는 안에 스타일값 다 들어있으니까 통째로 복사하고 안에내용만 하드코딩하시면됩니다요 -->
	...
	<span style="font-size:12px; color:#888888;">></span>
	<span style="font-size:12px; color:#888888;"><a href="/employee/stuadmin/recordAdminList">학적관리</a></span>
	<span style="font-size:12px; color:#888888;">></span>
	<span style="font-size:12px; color:#888888;"><a href="/employee/stuadmin/recordAdminList">학적변경신청내역</a></span>
	</div>
	...
	Swal.fire({
	      ...
	      /* reverseButtons: true, */ // 버튼 순서 거꾸로
	    	...
	    	if (result.isConfirmed) {
              ...
              console.log("학적변경 승인이 완료되지 않았습니다.");
          }
	    })
