...
<style>
	...
	.counsel_box tr td:nth-child(2){width:55%;}
	.counsel_box tr td:nth-child(3){width:20%;}
	.counsel_box tr td:nth-child(4){width:20%;}
</style>
...
<div class="counsel_box">
	...
	<span style="font-size:12px; color:#888888;">></span>
	<span style="font-size:12px; color:#888888;"><a href="/professor/lecture/list">현재학기강의</a></span>
	</div>
	<div class="table_topic">현재학기강의<i class="fa-solid fa-circle-info" style="color: #333333;"></i></div>
	<table>
		...
		<c:forEach var="lectureVO" items="${lectureVOList}" varStatus="stat">
			<tr>
				<td>${stat.count}</td>
				<td style="text-align: left;"><a style="display:block;" href="/professor/lecture/detail?lecCd=${lectureVO.lecCd}&lecNm=${lectureVO.lectureApplyVO.lecaNm}" style="text-align: left;">${lectureVO.lectureApplyVO.lecaNm}</a></td>
