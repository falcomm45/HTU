...
<style>
	...
	.testContent p {margin-bottom: 10px;}
	.testSelect {width: 100px;}
	.testTitle {width: 400px;}
	.testDate {width: 250px;}
	.testTime {width: 100px;}
	.testCon {width: 100%;}
	.tc {margin: 0 10px;}
	.testQuestion {margin-top: 25px;}
	.questionHeader {
...
<div class="testWrap">
	<div style="font-size:12px; color:#888888; margin-bottom: 20px;">
		...
		<div class="testBody">
			...
			<div class="btnbar">
				<a href="/professor/test/testResultList?lecCd=${param.lecCd}&testCd=${testVO.testCd}" class="testBtn btn-two mini sky" style="margin-right: 0px;">목록</a>
			</div>
		</div>
</div>
