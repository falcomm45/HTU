...
<div class="divMailbox" style="background-color: #ffffff; height: 100%;">
	<div class="mailHeader">
		<div class="mailHeaderName">
			<a href="/mail/inbox" style="color: #333333; display: flex;">
			...
			<span style="padding-left: 5px;">받은 메일함</span>
			</a>
		</div>
	</div>
<!-- ----------------------------------------------------------------------------- -->
		...
		<div class="mail_toolbar_task">
			<div class="button_group_mail">
				<div class="button_task_wrap">
					...
					<a href="/mail/inbox" id="btnList" class="mail_btn" type="button">
						<span class="text" style="font-weight: bold; font-size: 14px;">목록</span>
					</a>
<%-- 					<a href="/mail/sendMail?umlSender=${univMailVO.umlSender}&senderNm=${univMailVO.userVO.userNm}" class="mail_btn" type="button"> --%>
					<a href="/mail/sendMail?umlCd=${univMailVO.umlCd}" class="mail_btn" type="button">
						<span class="text" style="font-weight: bold; font-size: 14px;">답장</span>
					</a>
				</div>
			</div>
		</div>
