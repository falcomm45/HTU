...
<div class="record_box">
	...
	<span style="font-size:12px; color:#888888;">></span>
	<span style="font-size:12px; color:#888888;"><a href="/student/academicAdmin/recordApp3">자퇴신청</a></span>
	</div>
<form name="frm"
	...
	<div class="table_topic" style="margin-bottom:40px; padding-bottom:15px; border-bottom:1px solid #d1d0d0;">자퇴신청서</div>
	<!-- 내학번 -->
...
<%-- 	<input type="text" name="stuCd" hidden="hidden" value="${userVO.userCd}">  --%>
	...
	<!-- 학적상태 :  -->
	<input type="text" name="comdCd" id="comdCd" hidden="hidden" value="RECD03">
	...
	<div class="record_form_title">
	  ...
	  <div style="display:flex; flex-direction:column; margin-bottom:40px; margin-top:10px;">
	  	<p style="margin-bottom:10px;">자퇴사유</p>
