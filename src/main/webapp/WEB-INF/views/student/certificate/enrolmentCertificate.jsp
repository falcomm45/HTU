...
<sec:authentication property="principal.userVO" var="userVO"/>
	<div style="position:fixed;">
		<button type="button" id="btnPdf" class="btn-two mini bur" style=" width: 65px; height:40px; box-shadow:3px 3px 5px gray; font-size:14px; margin-left:795px;">인쇄</button>
	</div>
	<!-- 재학신청서 -->
	...
	function sweetConfirmDelete() {
	    Swal.fire({
	        ...
	        if (result.isConfirmed) {
	            // "네"를 클릭했을 때의 동작
	        	pdfPrint();
	        	alertSuccess("파일다운로드가 완료되었습니다." );
// 	        	,"/student/certificate/payment?stuCd=" + ${stuPrivacyInfoVO.stuCd}
	        } else {
	            // "아니오"를 클릭했을 때의 동작
	...
	function pdfPrint() {
	    ...
	    html2canvas(element, options).then(function (canvas) {
	        ...
	        // 파일 저장
	        doc.save('${stuPrivacyInfoVO.userVO.userNm} 재학증명서.pdf');
	    });
	}
//     function pdfPrint(){
