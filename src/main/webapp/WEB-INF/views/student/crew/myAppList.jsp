...
<div class="crew_box">
	<div style="font-size:12px; color:#888888; margin-bottom: 20px;">
		...
		<span style="font-size:12px; color:#888888;">></span>
		<span style="font-size:12px; color:#888888;"><a href="/student/crew/myAppList">개설신청내역</a></span>
	</div>
	<div class="table_topic">개설신청내역<i class="fa-solid fa-circle-info" style="color: #333333;"></i></div>
