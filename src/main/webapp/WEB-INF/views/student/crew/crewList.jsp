...
<style>
	.crew_box{width:100%; padding:40px; background-color:#ffffff; height:100%; overflow-y:scroll;}
	...
	.crew_box tr td:nth-child(5){width:10%;}
...
<div class="crew_box">
	<div style="font-size:12px; color:#888888; margin-bottom: 20px;">
		...
		<span style="font-size:12px; color:#888888;">></span>
		<span style="font-size:12px; color:#888888;"><a href="/student/crew/crewList">동아리 조회</a></span>
	</div>
	<div class="table_topic">동아리 조회<i class="fa-solid fa-circle-info" style="color: #333333;"></i></div>
