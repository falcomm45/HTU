...
<style>
	...
	.crew_box tr td:nth-child(3){width:35%;}
	.crew_box tr td:nth-child(4){width:15%;}
	.crew_box tr td:nth-child(5){width:25%;}
</style>
...
<div class="crew_box">
	<div style="font-size:12px; color:#888888; margin-bottom: 20px;">
		...
		<span style="font-size:12px; color:#888888;">></span>
		<span style="font-size:12px; color:#888888;"><a href="/student/crew/myCrew">나의 동아리</a></span>
	</div>
	<div class="table_topic">나의 동아리<i class="fa-solid fa-circle-info" style="color: #333333;"></i></div>
	...
	<table>
		...
		<c:forEach var="crewVO" items="${myCrew}" varStatus="stat">
			<tr>
				<td>${stat.count}</td>
				<td>
