...
public class ArticlePage<T> {
	...
	public ArticlePage(int total2, int currentPage2, int i, int j, List<BoardVO> list) {
	...
	public String getPagingArea() {
		...
		pagingArea +="class='page-link'><img src='/resources/images/back.png' style='width:20px; height:20px; opacity:70%;' /></a></li>";
		...
		pagingArea +="class='page-link'><img src='/resources/images/next.png' style='width:20px; height:20px; opacity:70%;' /></a></li></ul></div></div>";
