...
import kr.or.ddit.vo.KakaoPayReadVO;
...
public class KakaoPay {
    ...
    public String kakaoPayReady() {
        ...
        headers.add("Authorization", "KakaoAK " + "31aebd071d704f0090c7626add77a142");
        ...
        params.add("partner_order_id", "PAYM01");
        params.add("partner_user_id", "student");
        params.add("item_name", "기숙사등록비");
        params.add("quantity", "1");
        params.add("total_amount", "1500000");
        params.add("tax_free_amount", "1500000");
